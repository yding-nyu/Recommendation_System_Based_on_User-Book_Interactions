...
The instructions for our project and this repository can be found :point_right: [here](https://github.com/nyu-big-data/final-project-bd_project/blob/master/Guidance.md).

And the final report can be found :point_right:[here](https://github.com/nyu-big-data/final-project-bd_project/blob/master/1004_Final_Report.pdf).

We would like to thank Prof Brian McFee, Junge and Jack for the guidance and support throughout the course, especially during this hard time. Thank you all a lot!
